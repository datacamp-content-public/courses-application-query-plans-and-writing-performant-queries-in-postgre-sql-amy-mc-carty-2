...
---
## Setting up a Partition: Indexes
...
`@script`
Indexes should be created on the partition key, as in the example shown here. An index must be created on each child table.
